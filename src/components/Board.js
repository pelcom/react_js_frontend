...
//npm install --save semantic-ui-react pressed react-key-handler
//npm install --save pressed ajv react-key-handler
pressed.start()
...
class Board extends Component {
  ...
  setBoard(props) {
    ...
    if(newTotalObstacles !== undefined && newTotalObstacles === 0) {
