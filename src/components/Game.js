...
class Game extends Component {
  ...
  setPlayerPosition() {
    ...
    this.setState({playerPosition, showBoard: true})
  }
  ...
  countTotalMoves() {
    let hhh = this.state.totalMoves;
    hhh= hhh+1;
    this.setState({totalMoves: hhh});
  }
  handleKeyUp(e) {
    e.preventDefault()
    ...
    return (
      <div>
...

        {
          ...
          (<Board randomPositions={this.state.randomPositions} boardWidth={this.state.boardWidth}  boardHeight={this.state.boardHeight} playerPosition={this.state.playerPosition}
